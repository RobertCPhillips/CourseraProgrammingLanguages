...
if not ((c2.is_a? VerticalLine) and c2.x == THREE )
  ...
  puts "*****VerticalLine Test 5 successfull"
end
c3 = c.intersect(VerticalLine.new(FOUR))
if not ((c3.is_a? NoPoints))
	puts "VerticalLine intersect not working properly"
else
  puts "*****VerticalLine Test 6 successfull"
end
...
if not (d.eval_prog([]) == d)
  ...
  puts "*****LineSegment Test 1 successfull"
end
...
if not ((d2.is_a? Point)and d2.x == ONE and d2.y == TWO) 
  ...
  puts "*****LineSegment Test 2 successfull"
end
...
if not (d.x1 == -THREE and d.y1 == -FOUR and d.x2 == ONE and d.y2 == TWO)
  ...
  puts "*****LineSegment Test 3 successfull"
end
...
if not (d3.x1 == ZERO and d3.y1 == ONE and d3.x2 == FOUR and d3.y2 == SEVEN)
  ...
  puts "*****LineSegment Test 4 successfull"
end
...
if not ((l1.is_a? LineSegment) and l1.x1 == -ONE and l1.y1 == -TWO and l1.x2 == THREE and l1.y2 == FOUR)
	puts "Let eval_prog should evaluate e2 after adding [s, e1] to the environment"
else
  puts "*****Let Test 1 successfull"
end
...
if not ((l2.is_a? LineSegment) and l2.x1 == -ONE and l2.y1 == -TWO and l2.x2 == THREE and l2.y2 == FOUR)
	puts "Let eval_prog should evaluate e2 after adding [s, e1] to the environment"
else
  puts "*****Let Variable Shadowing Test 1 successfull"
end
